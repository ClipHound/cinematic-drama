    ...
    async function activate() {
      ...
      const timeline = new InteractionTimeline({
        ...
        onActivate: (point: InteractionPoint) => {
          ...
          if (!layer) return;
          layer.style.zIndex = point.component === 'sugar_storm' ? '45' : '30';
        ...
        {episodes.map((episode, index) => {
          ...
          return (
            ...
            >
              ...
              <div data-video-control ref={(node) => { layerRefs.current[index] = node; }} className="pointer-events-none absolute inset-0 z-30 overflow-hidden" />
